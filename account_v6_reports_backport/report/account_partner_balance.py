...
report_sxw.report_sxw('report.v6.account.partner.balance', 'res.partner', 'addons/account_v6_reports_backport/report/account_partner_balance.rml',parser=partner_balance, header=False)
