...
#    Copyright (C) 2010-2011 OpenERP SA (<http://openerp.com>). All Rights Reserved
#    Copyright (C) 2011 SYLEAM (<http://syleam.fr>). Christophe CHAUVET
#
...
class network_changes(osv.osv):
    """
    History all changes on this machine
    """
