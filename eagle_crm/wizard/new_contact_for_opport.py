# -*- coding: utf-8 -*-
#
#  File: wizard/new_contact_for_opport.py
#  Module: eagle_crm
#
...
class new_contact_for_opport(osv.osv_memory):
	"""Create a contact for an opportunity with a partner"""
	
	_name = 'eagle.contact4opport'
	...
	def make_contact(self, cr, uid, ids, context=None):
		...
		for data in self.browse(cr, uid, ids):
			...
			opport = self.pool.get('crm.lead').browse( cr, uid, context['active_id'], context=context )
			job_id = job_obj.create(cr, uid, {
				'address_id': opport and opport.partner_address_id and opport.partner_address_id.id or False,
