...
class account_print_journal(osv.osv_memory):
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False):
        res = super(account_print_journal, self).fields_view_get(cr, uid, view_id=view_id, view_type=view_type, context=context, toolbar=toolbar)
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        ...
        return {'type': 'ir.actions.report.xml', 'report_name': 'v6.account.journal.period.print', 'datas': data}
