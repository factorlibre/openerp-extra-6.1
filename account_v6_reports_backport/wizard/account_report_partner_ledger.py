...
class account_partner_ledger(osv.osv_memory):
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False):
        res = super(account_partner_ledger, self).fields_view_get(cr, uid, view_id=view_id, view_type=view_type, context=context, toolbar=toolbar)
    ...
    _defaults = {
       ...
       'reconcil': lambda *a: True,
       'initial_balance': lambda *a: True,
       'page_split': lambda *a: False,
       'result_selection': lambda *a: 'customer',
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        ...
        if data['form']['page_split']:
            return {
                ...
                'report_name': 'v6.account.third_party_ledger',
                'datas': data,
        }
        return {
                'type': 'ir.actions.report.xml',
                'report_name': 'v6.account.third_party_ledger_other',
                'datas': data,
        }
