...
##############################################################################
{
    ...
    "update_xml" : ["cci_mission_wizard.xml", "cci_mission_view.xml","cci_mission_report.xml","cci_mission_workflow.xml",'security/security.xml','security/cci_missions_security.xml','security/ir.model.access.csv'],
    "active": False,
    "installable": True
}
