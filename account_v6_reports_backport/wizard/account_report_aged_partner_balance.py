...
class account_aged_trial_balance(osv.osv_memory):
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False):
        res = super(account_aged_trial_balance, self).fields_view_get(cr, uid, view_id=view_id, view_type=view_type, context=context, toolbar=toolbar)
    ...
    _defaults = {
        ...
        'direction_selection': lambda *a: 'past',
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        ...
        return {
            ...
            'report_name': 'v6.account.aged_trial_balance',
            'datas': data
        }
