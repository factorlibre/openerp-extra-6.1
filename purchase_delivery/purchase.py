...
#         'dest_address_id':fields.many2one('res.partner.address', 'Destination Address', states={'posted':[('readonly',True)]},required =True),
    }
    ...
    def action_ship_create(self, cr, uid, ids, *args):
        result = super(purchase_order, self).action_ship_create(cr, uid, ids, *args)
