...
report_sxw.report_sxw('report.v6.account.general.ledger_landscape', 'account.account', 'addons/account_v6_reports_backport/report/account_general_ledger_landscape.rml', parser=general_ledger, header=False)
