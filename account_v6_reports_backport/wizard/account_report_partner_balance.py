...
class account_partner_balance(osv.osv_memory):
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False):
        res = super(account_partner_balance, self).fields_view_get(cr, uid, view_id=view_id, view_type=view_type, context=context, toolbar=toolbar)
    ...
    _defaults = {
        ...
        'display_partner': lambda *a: 'non-zero_balance',
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        ...
        return {
            ...
            'report_name': 'v6.account.partner.balance',
            'datas': data,
    }
