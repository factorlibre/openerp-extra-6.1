...
class account_central_journal(osv.osv_memory):
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False):
        res = super(account_central_journal, self).fields_view_get(cr, uid, view_id=view_id, view_type=view_type, context=context, toolbar=toolbar)
    ...
    def _build_context(self, cr, uid, ids, data, context=None):
        if context is None:
            context = {}
        result = super(account_central_journal, self)._build_context(cr, uid, ids, data, context=context)
        if data['form']['filter'] == 'filter_date':
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        ...
        return {
                ...
                'report_name': 'v6.account.central.journal',
                'datas': data,
        }
