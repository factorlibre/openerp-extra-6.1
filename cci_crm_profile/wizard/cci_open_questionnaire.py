...
class open_questionnaire(wizard.interface):
    ...
    def _get__questionnaire(self, cr, uid, data, context):
        self._questionnaire_choice_fields['questionnaire_name']['domain'] = "[('target','=','%s')]"% (str(data['model']))
        return {}
...
open_questionnaire('cci.open_questionnaire')
