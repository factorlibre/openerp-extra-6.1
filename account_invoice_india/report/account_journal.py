...
class journal_print(report_sxw.rml_parse):
	...
	def lines(self, period_id, journal_id, *args):
		...
		self.cr.commit()
		self.cr.execute('select id from account_move_line where period_id=%d and journal_id=%d and state<>\'draft\' order by date,ref', (period_id, journal_id))
...
report_sxw.report_sxw(
	'report.account.journal.period.print.custom', 
	'account.journal.period', 
	'addons/account_invoice_india/report/account_journal.rml', 
