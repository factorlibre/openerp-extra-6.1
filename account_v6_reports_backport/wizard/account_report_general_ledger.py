...
class account_report_general_ledger(osv.osv_memory):
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False):
        res = super(account_report_general_ledger, self).fields_view_get(cr, uid, view_id=view_id, view_type=view_type, context=context, toolbar=toolbar)
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        ...
        return { 'type': 'ir.actions.report.xml', 'report_name': 'v6.account.general.ledger_landscape', 'datas': data}

    _defaults = {
        'amount_currency': lambda *a: True,
        'sortby': lambda *a: 'sort_date',
        'initial_balance': lambda *a: False,
        ...
        'period_to': lambda *a: False,
        'period_from': lambda *a: False,
    }
