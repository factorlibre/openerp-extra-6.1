...
report_sxw.report_sxw('report.v6.account.account.balance', 'account.account', 'addons/account_v6_reports_backport/report/account_balance.rml', parser=account_balance, header=False)
