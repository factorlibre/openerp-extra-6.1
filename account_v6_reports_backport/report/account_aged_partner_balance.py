...
report_sxw.report_sxw('report.v6.account.aged_trial_balance', 'res.partner',
        'addons/account_v6_reports_backport/report/account_aged_partner_balance.rml',parser=aged_trial_report, header=False)
