...
#                    "AND " + self.query +" " \
    ...
    def lines(self, partner):
        ...
        self.cr.execute(
            "SELECT l.id, l.date, j.code, acc.code as a_code, acc.name as a_name, l.ref, m.name as move_name, l.name, l.debit, l.credit, l.amount_currency,l.currency_id, c.code AS currency_code " \
...
report_sxw.report_sxw('report.v6.account.third_party_ledger', 'res.partner',
        'addons/account_v6_reports_backport/report/account_partner_ledger.rml',parser=third_party_ledger,
        header=False)
report_sxw.report_sxw('report.v6.account.third_party_ledger_other', 'res.partner',
        'addons/account_v6_reports_backport/report/account_partner_ledger_other.rml',parser=third_party_ledger,
        header=False)
