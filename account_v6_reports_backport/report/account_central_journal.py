...
report_sxw.report_sxw('report.v6.account.central.journal', 'account.journal.period', 'addons/account_v6_reports_backport/report/account_central_journal.rml', parser=journal_print, header=False)
