...
report_sxw.report_sxw('report.v6.account.general.journal', 'account.journal.period', 'addons/account_v6_reports_backport/report/account_general_journal.rml', parser=journal_print, header=False)
